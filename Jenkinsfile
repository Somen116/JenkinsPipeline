pipeline {
  ...
  parameters {
    ...
    string defaultValue: 'somen16081993@gmail.com', description: 'Success_Email', name: 'Success_Email'
    string defaultValue: 'somen16081993@gmail.com', description: 'Failure_Email', name: 'Failure_Email'
  }
...
def checkholiday() {
  def dates = []
  def response = httpRequest 'https://calendarific.com/api/v2/holidays?&api_key=90e19de04681bc27e9492b478df436f43aed8c4c&country=IN&year=2022'
